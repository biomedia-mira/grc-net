...
def train(args):
    ...
    dataset_train_base = ImageSegmentationOneHotDataset(args.train, 
                                                        ...
                                                        mode="TotalSegmentator", normalizer=config.normalizer, binarize=config.config['binarize'], augmentation=True)
    ...
    if args.val is not None:
        ...
        dataset_val = ImageSegmentationOneHotDataset(args.val,
                                                     config.config['num_classes'], config.config['size'], config.config['spacing'],
                                                     mode="TotalSegmentator", normalizer=config.normalizer, binarize=config.config['binarize'], augmentation=False)
...
if __name__ == '__main__':
    ...
    # Logging args
    parser.add_argument('--out', default='output/mm-whs/totalsegmentator/full-stn', help='output root directory')
    parser.add_argument('--model', default='output/mm-whs/totalsegmentator/full-stn/train/model', help='model directory')
